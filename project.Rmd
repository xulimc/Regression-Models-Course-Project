...
We examine the residuals plot as Figure 5. It can be shown that the residual plots are randomly around the x-axis. So a linear regression model is appropriate for the "mtcars" data set.
